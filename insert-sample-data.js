...
Regarding Internet usage by age, the 14-17 age group consistently had the highest percentage throughout the period, starting at around 2% in 1994 and reaching approximately 90% by 2009. The 18-24 group followed a similar pattern but at lower levels, beginning at about 1% and ending at around 80%.

Older age groups showed more gradual increases. Those aged 25-34 started at nearly 0% and reached about 75% by 2009. The 35-49 group began at 0% and ended at approximately 60%, while those aged 50-64 started at 0% and reached around 45%. People over 65 had the lowest usage, starting at 0% and ending at just over 20%.
...
One primary reason is the demanding nature of modern work. Many jobs require employees to work long hours, often extending beyond the standard 40-hour workweek. In competitive industries, people feel pressured to work overtime to meet deadlines and demonstrate commitment to their employers. Additionally, technology has blurred the boundaries between work and personal life. Smartphones and laptops enable constant connectivity, making it difficult for people to disconnect from work even during leisure time.

Another factor is economic pressure. In many countries, the cost of living has risen significantly, requiring both partners in a household to work full-time to maintain their standard of living. This leaves little time for family responsibilities, childcare, or personal pursuits. Furthermore, the gig economy and freelance work have created uncertainty, leading people to take on multiple jobs or work irregular hours to ensure financial stability.

To address these issues, several measures can be implemented. Employers should promote flexible working arrangements, such as remote work options and flexible hours. This would allow employees to better manage their time and reduce commuting stress. Governments could also introduce policies that limit maximum working hours and guarantee paid parental leave.
